...
import com.example.rabam.model.DTO.AdressCoordinate;
...
public class SideService {
    ...
    public AdressCoordinate findCoordinate(String address) throws IOException {
        ...
        AdressCoordinate coordinate = new AdressCoordinate(lon, lat);
        return coordinate;
    }
